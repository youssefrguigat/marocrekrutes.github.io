...
if(isset($_POST['btn-signup']))
{
	...
	$stmt = $reg_user->runQuery("SELECT * FROM candidat WHERE userEmail=:email_id");
	...
	{
		if($reg_user->register($gender,$firstname,$lastname,$email,$ucpass,$tel,$reg_date,$token))
		{			
			$id = $reg_user->lastId();		
			...
			$message = "					
						...
						<br /><br />
						Nous vous remercions d'avoir choisi Maroc-ReKrute.com pour gérer votre carrière en ligne et vous souhaitons la bienvenue sur nos pages.<br/>
			...
			$subject = "Confirmation de votre compte candidat Maroc-ReKrute.com";
   ...
   <div class="signup-form-container1">
      <form role="form" method="post" id="register-form" autocomplete="off">
         ...
         <div class="form-header">
            <h1 class="form-title"><i class="fa fa-user" aria-hidden="true"></i> Inscription candidat: Information de base</h1>
